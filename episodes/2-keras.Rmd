...
Here are more explanations of this confusion matrix and the classification model (if the exact numbers differs, this might be due to the random state as discussed above).
