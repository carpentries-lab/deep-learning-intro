...
#### (optional) Calculate outputs for a network
...
:::: solution
## Solution
#### Solution to 'calculate the output for one neuron'
...
#### Solution to 'Calculate outputs for a network'
1.
| x1 | x2 | y     |
|----|----|---    |
| 0  | 0  | **0** |
...
| 1  | 1  | **0** |
| 1  | 0  | **1** |
2. This solves the XOR logical problem, the output is 1 if only one of the two inputs is 1.
