...
![A visualisation of the Machine Learning Pipeline](../fig/graphviz/pipeline.png){alt="A flow diagram illustrating the ten-step deep learning pipeline described in the lesson introduction."}
...
![Dropout sketch](../fig/neural_network_sketch_dropout.png){alt='A sketch of a neural network with and without dropout'}
...
![Output of plotting sample](../fig/03_training_history_4_rmse_dropout.png){alt='Output of plotting sample'}
...
![Output of plotting sample](../fig/03_monte_carlo_dropout_distribution_example.png){alt='bar plot summarising distribution of frequencies of predictions with different numbers of hours of sunshine'}
...
```
![Output of plotting sample](../fig/03_scatter_plot_model_uncertainty.png){alt='scatter plot of mean predicted hours of sunshine against true values, colored by standard deviation of the predictions, showing some correlation between the predictions from the model and the observed data'}
